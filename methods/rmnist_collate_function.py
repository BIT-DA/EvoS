...
class rmnist_BaseCollateFunction(nn.Module):
    ...
    def __init__(self, transform: torchvision.transforms.Compose):
        ...
        super(rmnist_BaseCollateFunction, self).__init__()
    ...
    def forward(self, batch: List[tuple]):
        """Turns a batch of tuples into a tuple of batches.
            ...
            Examples:
                ...
                >>> collate_fn = rmnist_BaseCollateFunction(transform)
                >>>
...
class rmnist_ImageCollateFunction(rmnist_BaseCollateFunction):
    """Implementation of a collate function for images.

    This is an implementation of the rmnist_BaseCollateFunction with a concrete
    set of transforms.
    ...
    def __init__(self,
        ...
        super(rmnist_ImageCollateFunction, self).__init__(transform)


class rmnist_MultiViewCollateFunction(nn.Module):
...
class rmnist_SimCLRCollateFunction(rmnist_ImageCollateFunction):
    ...
    Examples:
        ...
        >>> # SimCLR for ImageNet
        >>> collate_fn = rmnist_SimCLRCollateFunction()
        >>>
        >>> # SimCLR for CIFAR-10
        >>> collate_fn = rmnist_SimCLRCollateFunction(
        >>>     input_size=32,
    ...
    def __init__(self,
        ...
        super(rmnist_SimCLRCollateFunction, self).__init__(
...
class rmnist_MoCoCollateFunction(rmnist_ImageCollateFunction):
    ...
    Examples:
        ...
        >>> collate_fn = rmnist_MoCoCollateFunction()
        >>>
    ...
    def __init__(self,
        ...
        super(rmnist_MoCoCollateFunction, self).__init__(
            input_size=input_size,
            cj_prob=cj_prob,
...
class MultiCropCollateFunction(rmnist_MultiViewCollateFunction):
...
class rmnist_SwaVCollateFunction(MultiCropCollateFunction):
    """Implements the multi-crop transformations for SwaV.
    ...
    Examples:
        ...
        >>> # SwaV for Imagenet
        >>> collate_fn = rmnist_SwaVCollateFunction()
        >>>
    ...
    def __init__(self,
        ...
        super(rmnist_SwaVCollateFunction, self).__init__(
